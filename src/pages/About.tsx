  ...
  return (
    <Card className="bg-green-50">
      ...
      <CardContent className="flex flex-col md:flex-row ">
        <img src="AnalysAbout.png" alt="" className="w-100 h-70 place"/>
        <div className="flex flex-col gap-4 px-5 text-green-900">
          <p className="text-base">
            DecentExpense is a modern, full-stack finance tracker designed to
            make managing your money simple, clear, and effective. Whether
            you're tracking your daily expenses or analyzing long-term financial
            trends, DecentExpense gives you the tools to stay in control of your
            finances.
          </p>
          <p className="text-base">
            ...
            easily understand where their money is going and make better
            financial decisions.
          </p>
          <p className="text-base">
            DecentExpense also includes role-based access, where admins can
            manage users and oversee the platform, while users (analysts) have
            full control over their financial data — including adding, editing,
